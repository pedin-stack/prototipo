...
// ponytail: SVGs inline no estilo Tabler — evita dependência de ícones para 8 desenhos
function icone(paths: ReactNode) {
  return function Icone({ size = 20, className }: IconProps) {
    return (
      <svg
        width={size}
        height={size}
...
export const IconAlertTriangle = icone(
  <>
    <path d="M12 9v4" />
...
export const IconMessageReport = icone(
  <>
...
export const IconStarFilled = icone(
